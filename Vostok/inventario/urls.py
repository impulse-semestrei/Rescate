...
from .views import crearInventarioView, agregar_material_inventario, ver_inventario, delete_inventario,\
    ver_inventario_material, eliminar_material_inventario, EditarInventario, checklist, editar_material, editar_inventario_view
...
urlpatterns = [
    ...
    path('editar_inventario/<int:pk>/', EditarInventario.as_view(), name="editar_inventario_view"), ######## US08 ########
]
