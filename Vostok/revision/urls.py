...
from .views import ver_revisiones, ver_detalle_revsion, ver_revisiones_ambulancia, ver_detalle_ambulancia, Reportes
...
urlpatterns = [
    ...
    path('reportes/', Reportes, name='reportes_materiales'),###### URLS US58 #####
]
